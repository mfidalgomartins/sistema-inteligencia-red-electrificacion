"""Ejecución ordenada de la capa SQL DuckDB: staging, integración, marts y KPIs."""
...
EXPORT_OBJECTS = {
    ...
    "validation_checks": "validation_checks_sql.csv",
...
def run_sql_layer() -> dict[str, pd.DataFrame]:
