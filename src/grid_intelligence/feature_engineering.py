"""Construcción de variables analíticas por nodo-hora, zona-día y zona-mes."""
...
def build_features(force_sql_refresh: bool = False) -> dict[str, pd.DataFrame]:
...
if __name__ == "__main__":
    dfs = build_features(force_sql_refresh=False)
