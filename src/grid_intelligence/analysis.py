"""Síntesis analítica: hallazgos operativos, de servicio y económicos a partir de los marts."""
...
def run_advanced_analysis() -> dict[str, pd.DataFrame]:
    ...
    b5_electr = zone_day.groupby("zona_id", as_index=False).agg(
        ...
        [
            {
                ...
                "evidencia": f"Los 10 nodos líderes concentran {b2_nodes.head(10)['horas_congestion'].sum():,.0f} horas de congestión.",
            ...
            {
                "prioridad": 4,
                "hallazgo": "Vehículos eléctricos + electrificación industrial incrementan presión de absorción.",
                "evidencia": f"Zona con mayor ratio nueva demanda: {b5_electr.iloc[0]['zona_id']}.",
                "implicacion": "Reforzar pronóstico y flexibilidad antes de escalada estructural de CAPEX.",
            },
            {
                "prioridad": 5,
        ...
        "cells": [
            ...
            },
            {
                ...
                "source": [
                    ...
                    "Se cargan las tablas procesadas por el flujo canónico.\\n",
                ],
            },
            {
                "cell_type": "code",
                ...
                "source": [
                    ...
                    "scenario_summary = pd.read_csv(root / 'data' / 'processed' / 'scenario_summary.csv')\\n",
                    "findings.head(10)\\n",
                ],
            },
            {
                ...
                "metadata": {},
                "source": [
                    "## Zonas líderes por riesgo operativo\\n",
            ...
            },
            {
                ...
                "source": [
                    ...
                    "Lectura rápida de compensaciones entre riesgo residual e inversión requerida.\\n",
                ],
            },
            {
                "cell_type": "code",
    ...
    (paths.root / "notebooks" / "proyecto_principal.ipynb").write_text(
