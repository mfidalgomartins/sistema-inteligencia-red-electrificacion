...
| zone_month_features.csv                        |
        ...
        - Reports: 26 archivos en outputs/reports.
...
|----------------:|:----------|----------------------------:|:------------|:---------------|:-------------------------------|:---------------------------|:-----------------------|:-------------------------------------|
|               1 | Z013      |                     87.7402 | critico     | inmediata      | congestion_risk_score          | optimizar_operacion        | 0-3m                   | media_confianza_requiere_seguimiento |
|               2 | Z021      |                     68.3962 | alto        | planificada    | economic_priority_score        | optimizar_operacion        | 0-3m                   | media_confianza_requiere_seguimiento |
|               3 | Z020      |                     65.0796 | alto        | planificada    | electrification_pressure_score | optimizar_operacion        | 0-3m                   | alta_confianza                       |
|               4 | Z011      |                     62.456  | alto        | planificada    | electrification_pressure_score | optimizar_operacion        | 0-3m                   | alta_confianza                       |
|               5 | Z015      |                     55.5782 | medio       | planificada    | flexibility_gap_score          | optimizar_operacion        | 0-3m                   | alta_confianza                       |
...
19 passed in 1.40s
        ...
        - dashboard_sha256: 255228c5fe3abdfd4be1b2ec4510bb5aef7d64a40f36ff8b070eb18c22b47007
