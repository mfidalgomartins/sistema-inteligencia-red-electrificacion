...
|:--------------------------------|:---------|:-------------|:--------------------------------------------------------------------------------------------------------------------------|
| official_dashboard_exists       | True     | True         | /Users/miguelfidalgo/Documents/sistema-inteligencia-red-electrificacion/outputs/dashboard/dashboard_inteligencia_red.html |
| official_dashboard_singleton    | True     | False        | Solo dashboard_inteligencia_red.html debe ser oficial                                                                     |
